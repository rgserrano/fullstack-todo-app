...
module.exports = class PGPersistence {
  ...
  async sortedTodoLists() {
    ...
    let resultBoth = await Promise.all([resulTodoLists, resultTodos]);
    ...
    // finds the todolists
    // finds the todos for each todolist, and appends them to the todos. 

    // ALTERNATIVE
    // find the todolists
    // find the todos
    // for each todolist, filter the todos that have the matching id. 
    // partition them. 
